      ...
      if (claimed) {
        try {
          await notifyOrderPaid({
            ...
            estimatedDeliveryDate: paidOrder.deliveredAt,
            viewOrderUrl: `${process.env.NEXT_PUBLIC_SITE_URL ?? "https://www.firaang.com"}/track-order?orderId=${encodeURIComponent(paidOrder.id)}`,
